...
class SnippetDialog(ctk.CTkToplevel):
    ...
    def _build_ui(self):
        ...
        self._shortcut_entry = ctk.CTkEntry(
            self, textvariable=self._shortcut_var, height=34, width=340
        )
        ...
        btn_row.grid(row=5, column=0, padx=20, pady=(8, 16), sticky="ew")
        ...
        ctk.CTkButton(btn_row, text="Save", width=100,
                      command=self._on_save_click).grid(row=0, column=1, sticky="e")
